package org.wodichka.copyblockid.neoforge;
...
public final class CopyBlockIdNeoForge {
    ...
    public CopyBlockIdNeoForge() {
        ...
        FluidNameProvider.setProvider(CopyBlockIdNeoForge::getFluidHoverName);
